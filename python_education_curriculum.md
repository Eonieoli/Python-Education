...
- **리스트와 내장 함수**
  - 리스트와 내장 함수 - 통계 구하기
  - 👉 Practice: 내장 함수 연습
  - 👉 Practice: 문자열에서도 사용 가능
  - ✏️ Exercise: 내장 함수 (3-4문제)
...
- **타입 힌트로 함수 명확하게 만들기** (FastAPI에서 준비!)
  - 타입 힌트가 필요한 이유 (Day 1 복습)
  - 매개변수 타입 힌트
  - 👉 Practice: 타입 힌트가 있는 함수
  - 반환 타입 힌트 (-> 화살표)
  - 👉 Practice: 완전한 타입 힌트 함수
  - 타입 힌트의 장점 (VS Code 자동완성, 버그 예방)
  - 👉 Practice: 딕셔너리 반환 함수에 타입 힌트 추가
  - ✏️ Exercise: 타입 힌트 활용 (2-3문제)
...
- **클래스 구조**
  ...
  - 👉 Practice: self 이해하기
  - 클래스의 타입 힌트
  - 👉 Practice: 타입 힌트가 있는 클래스 만들기
  - ✏️ Exercise: 클래스 기본 (3-4문제)

- **클래스 활용** (FastAPI Pydantic 모델과 유사!)
  - 클래스로 데이터 모델 만들기
  - 👉 Practice: Product 클래스 (name, price, stock)
  - 👉 Practice: 여러 인스턴스 생성
...
- **클래스 상속** (15분)
  ...
  - 👉 Practice: 상속 기본 구조 (Animal → Dog)
  - 👉 Practice: FastAPI 스타일 미리보기 (BaseModel 상속)
...
- **raise로 에러 던지기** (25분)
  - raise가 필요한 이유
  - 👉 Practice: 기본 raise (나이 검증)
  - 👉 Practice: 함수에서 조건 검증 + raise
  - 👉 Practice: raise + try-except 조합 (상품 검증)
  - ✏️ Exercise: raise 활용 (3문제)

- **else - 예외가 없을 때** (10분)
  - else가 필요한 이유
  - try vs else 차이
  - 👉 Practice: 딕셔너리 조회 with else
  - 👉 Practice: 리스트 검색 with else

- **finally** (5분)
  - finally의 용도 (항상 실행)
  - 👉 Practice: 카운터 증가 with finally
...
- **Python 클래스 복습 + 딕셔너리 변환** (30분)
  ...
  - 👉 Practice: 클래스를 딕셔너리로 변환 (__dict__)
